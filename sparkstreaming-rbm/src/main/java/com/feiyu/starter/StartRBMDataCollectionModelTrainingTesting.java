...
import com.feiyu.deeplearning.RBM.ThreadRBMWholeProcess;
...
public class StartRBMDataCollectionModelTrainingTesting {
  private static Logger log = Logger.getLogger(StartRBMDataCollectionModelTrainingTesting.class.getName());

  public StartRBMDataCollectionModelTrainingTesting() {
  ...
  private void startRBMWholeProcess() {
    ...
    log.debug("Starting "+ rbmWholeProcessThreadName +" at time "+System.currentTimeMillis());
    ...
    //			log.debug("PredictUserPreferences is interrupted at " + System.currentTimeMillis());
    //		}
    //		rbmWholeProcessThread.interrupt();
    //		log.debug(rbmWholeProcessThreadName + " ends at "+System.currentTimeMillis());
  }
