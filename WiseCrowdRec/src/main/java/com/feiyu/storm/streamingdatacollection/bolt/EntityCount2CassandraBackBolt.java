...
public class EntityCount2CassandraBackBolt implements IBasicBolt {
	private static final Logger _logger = LoggerFactory.getLogger(EntityCount2CassandraBackBolt.class);
	...
	public void execute(Tuple input, BasicOutputCollector collector) {
        ...
        try {
			GlobalVariables.AST_CASSANDRA_MNPLT.insertDataToDB_asynchronous(
					...
					Integer.toString(count), entityInfo.toString(),false);
